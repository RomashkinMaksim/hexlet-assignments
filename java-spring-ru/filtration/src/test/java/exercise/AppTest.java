...
public class AppTest {
    ...
    @Test
    void testFilterByFirstAndLastNameAndProfessionAndEmailAndGender() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(get("/users?firstName=t&lastName=w&profession=tuar&email=ill&gender=Male"))
                .andReturn()
                .getResponse();
